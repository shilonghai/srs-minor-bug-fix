...
DEPASFLAGS= $(CPPFLAGS)
YASM=/Users/admin/srs-csdn/trunk/objs/ffmpeg.src/_release/bin/yasm
DEPYASM=/Users/admin/srs-csdn/trunk/objs/ffmpeg.src/_release/bin/yasm
AR=ar
ARFLAGS=rc
AR_O=$@
RANLIB=ranlib
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L/Users/admin/srs-csdn/trunk/objs/ffmpeg.src/_release/lib -lm -ldl  -Wl,-dynamic,-search_paths_first
...
EXTRALIBS=-liconv -lx264 -lspeex -lmp3lame -lfdk-aac -lm -lbz2 -lz -lpthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
